...
struct SubscriptionView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $subscriptionPressed, onDismiss: {
            ...
            SubscriptionPressedView(subscriptionPressed: self.$subscriptionPressed, oldBrightness: self.$oldBrightness, isErased: self.$isErased, qrString: self.$qrString, id: self.$id, isExpired: isExpired)
